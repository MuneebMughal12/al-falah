        ...
        <div className="grid gap-10 lg:grid-cols-2 items-start">
          ...
          <div className="relative">
            ...
            <div className="hidden lg:block">
              {/* Card 1 (left-bottom under text) */}
              <div className="absolute -left-[540px] bottom-[-70px] w-[420px]">
                <FeatureCard
                  tone="green"
              ...
              {/* Card 2 (center bottom over laptop) */}
              <div className="absolute left-[-40px] bottom-[-40px] w-[360px]">
                <FeatureCard
                  tone="red"
              ...
              <div className="absolute right-[-200px] bottom-[-40px] w-[420px]">
                <FeatureCard
                  tone="purple"
